...
<template>
  ...
  <el-breadcrumb-item>角色管理</el-breadcrumb-item>  
    ...
    <el-card class="box-card">
      ...
      <el-input style="width: 15%" v-model="userlist.searchForm.userName" placeholder="请输入角色名称"></el-input>  
        <el-select style="width: 15%" v-model="userlist.searchForm.state" placeholder="请选择成员">
 ...
 <el-table
  ...
  <el-form :model="roleList.roleDetail" :rules="rules" ref="roleList.roleDetail" class="meeting_form">
    <el-form-item label="角色名称" prop="userName">
      <el-input v-model="roleDetail.userName" ></el-input>
    </el-form-item>
  </el-form>
 ...
 <!-- 人员维护 -->
  <el-dialog  :title="dialogTitle" :visible.sync="roleUserDialog">
