...
<template>
	<el-row>
		<el-col :span="10">
			<div class="sign_box">
				<p style="text-align: center">签到记录</p>
				<div>
	...
	<!-- --> 
    	...
    	<el-row>
    		...
    		<el-input v-model="signInfo.name" :readonly="true"></el-input>
  			</el-form-item>   
